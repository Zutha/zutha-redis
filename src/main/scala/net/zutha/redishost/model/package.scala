...
package object model {
  ...
  type IRefT[A <: ImmutableAccessor, +T[A1 <: A] <: IObject[A1]]  = IRefTA[A, T[A]]
  type IRefTA[A <: ImmutableAccessor, +TA <: IObject[A]]          = IRef[A] with TA
  type MRefT[A <: MutableAccessor, +T[A1 <: A] <: MObject[A1]]    = MRefTA[A, T[A]]
  type MRefTA[A <: MutableAccessor, +TA <: MObject[A]]            = MRef[A] with TA
